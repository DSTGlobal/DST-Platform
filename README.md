...
DST Platform — это гибридная система, объединяющая в себе возможности системы управления содержимым (CMS) и мощного CMF (Content Management Framework) на языке PHP. Это серверное решение с открытым исходным кодом, спроектированное для обеспечения максимальной гибкости и производительности.
